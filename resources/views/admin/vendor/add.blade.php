    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <h1 class="w-full text-3xl text-black pb-6">Thêm hãng</h1>

                <div class="flex flex-wrap">
                    @include('admin/error')
                    <form action="/admin/them-hang" method="POST" class="w-full mb-4">
                        @csrf
                        ...
                        <div class="flex flex-col md:flex-row justify-around p-4 bg-white rounded-lg shadow-lg text-lg mb-4">
                            <div>
                                <span>Tên hãng </span>
                                <input class="p-2 border border-slate-300 w-full md:w-[400px]" type="text" name="vendor_name" id="">
                            </div>
                        </div>
                        <div class="w-full mb-4">
                            ...
                            <div class="bg-white rounded-b-lg shadow-lg border-b border-slate-300">
                                <div class="mb-2">
                                    ...
                                    <div class="flex flex-col md:flex-row flex-wrap px-2">
                                        ...
                                        <div class="w-full flex flex-row justify-between md:px-[150px] text-lg py-2">
                                            ...
                                            <input type="checkbox" name="{{ $category['slug_vi'] }}" id="">
                                ...
                                <div class="mb-2 text-right">
                                    <button type="submit" class="bg-blue-600 p-2 text-lg text-white mr-2 rounded-lg shadow-lg">Thêm hãng</button>
                                </div>
                            </div>
                        </div>
                    </form>
