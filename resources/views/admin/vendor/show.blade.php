                ...
                <div class="flex flex-wrap">
                    ...
                    <form action="/admin/sua-hang/{{$vendor['id']}}" method="POST" class="w-full mb-4">
                        ...
                        <div class="flex flex-col md:flex-row justify-around p-4 bg-white rounded-lg shadow-lg text-lg mb-4">
                            <div>
                                <span>Tên hãng </span>
                                <input class="p-2 border border-slate-300 w-full md:w-[400px]" type="text" name="vendor_name" id="vendor_name" value="{{$vendor["vendor_name"]}}" readonly>
                            </div>
                        </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="flex flex-col md:flex-row flex-wrap px-2">
                                        ...
                                        <div class="w-full flex flex-row justify-between md:px-[150px] text-lg py-2">
                                            ...
                                            <input type="checkbox" name="{{ $category['slug_vi'] }}" id="" <?php if (isset($vendor_categories[$category['slug_vi']])) echo "checked" ?> disabled>
                                        </div>
                                        @endforeach
