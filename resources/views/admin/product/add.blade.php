    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                ...
                <form action="/admin/them-san-pham" method="post" class="flex flex-wrap">
                    @csrf
                    @include('admin/error')
                    <div class="w-full mb-4">
                        ...
                        <div class="flex flex-col gap-4 md:gap-0 md:gap-y-4 flex-wrap md:flex-row justify-around p-4 bg-white rounded-lg shadow-lg text-lg">
                            <div class="md:w-1/3">
                                ...
                                <input class="p-2 border border-slate-300" type="text" name="product_name" id="product_name">
                            </div>
                            
                            <div class="md:w-1/3">
                                <span>Danh mục</span>
                                <select name="category" id="category" onchange="changeVendor()" class="p-2">
                            ...
                            <div class="md:w-1/3">
                                <span>Phiên bản </span>
                                <input class="p-2 border border-slate-300" type="text" name="edition" id="edition">
                            </div>
                            <div class="md:w-1/3">
                                <span>Màu </span>
                                <input class="p-2 border border-slate-300" type="text" name="color" id="color">
                            </div>
                            <div class="md:w-1/3">
                                <span>Giá </span>
                                <input class="p-2 border border-slate-300" type="number" min="0" name="price" id="price">
                            </div>
                            <div class="md:w-1/2 flex flex-col">
                                <span>Thumbnail sản phẩm </span>
                                <div class="flex">
                                    <img id="thumbnail-image" class="w-28 md:w-56">
                                </div>
                    ...
                    <div class="w-full mb-4">
                        ...
                        <div class="bg-white rounded-b-lg shadow-lg border-b border-slate-300">
                            <textarea name="description" id="content" class="w-full"></textarea>
