                ...
                <form action="/admin/sua-san-pham/{{$product['id']}}" method="post" class="flex flex-wrap" enctype="multipart/form-data">
                    ...
                    <div class="w-full mb-4">
                        ...
                        <div class="flex flex-col gap-4 md:gap-0 md:gap-y-4 flex-wrap md:flex-row justify-around p-4 bg-white rounded-lg shadow-lg text-lg">
                            ...
                            <div class="md:w-1/3">
                                ...
                                <input class="p-2 border border-slate-300" type="text" name="product_name" id="product_name" value="{{$product['product_name']}}">
                            </div>
                            
                            <div class="md:w-1/3">
                                <span>Danh mục</span>
                                <select name="category" id="category" onchange="changeVendorEdit()" class="p-2">
                            ...
                            <div class="md:w-1/3">
                                <span>Hãng</span>
                                <select name="vendor" id="vendor" class="p-2">
                                    {{-- <option value="" hidden>Chọn danh mục</option> --}}
                                </select>
                            </div>
                            <div class="md:w-1/3">
                                <span>Phiên bản </span>
                                <input class="p-2 border border-slate-300" type="text" name="edition" id="edition" value="{{$product['edition']}}">
                            </div>
                            <div class="md:w-1/3">
                                <span>Màu </span>
                                <input class="p-2 border border-slate-300" type="text" name="color" id="color" value="{{$product['color']}}">
                            </div>
                            <div class="md:w-1/3">
                                <span>Giá </span>
                                <input class="p-2 border border-slate-300" type="number" min="0" name="price" id="" value="{{$product['price']}}">
                            </div>
                    ...
                    <div class="w-full mb-4">
                        ...
                        <div class="bg-white rounded-b-lg shadow-lg border-b border-slate-300">
                            <textarea name="description" id="content" class="w-full">{{ base64_decode($product['description']) }}</textarea>
