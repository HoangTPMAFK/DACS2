                ...
                <div class="flex flex-wrap">
                    <div class="w-full mb-4">
                        ...
                        <form action="/admin/sua-chi-nhanh/{{ $agency['id'] }}" method="post" class="flex flex-col md:flex-row justify-around p-4 bg-white rounded-lg shadow-lg text-lg">
                            ...
                            <div>
                                <span>Tên cơ sở </span>
                                <input class="p-2 border border-slate-300" type="text" name="agency_name" id="" value="{{$agency['agency_name']}}">
                            </div>
                            <div>
                                <span>Địa chỉ </span>
                                <input class="p-2 border border-slate-300" type="text" name="address" id="" value="{{$agency['address']}}">
                            </div>
                            <div class="mb-2 text-right">
                                <button class="bg-blue-600 p-2 text-lg text-white mr-2 rounded-lg shadow-lg">Sửa chi nhánh</button>
                            </div>
                        </form>
                    </div>
                </div>
