        ...
        <div class="container container-lg">
            <nav class="header-inner flex-between">
                ...
                <div class="flex items-center md:gap-[16px] max-sm:gap-0">
                    ...
                    <form action="cart.html#" class="flex items-center flex-wrap form-location-wrapper">
                ...
                <div class="2xl:w-3/12 flex-grow-0 flex-shrink-0 basis-auto xl:w-4/12">
                    <div class="cart-sidebar border border-gray-100 rounded-8 px-24 py-40">
                        ...
                        <div class="bg-color-three rounded-8 p-24">
                            ...
                            <div class="mb-0 flex-between gap-8"><span
                                class="text-gray-900 font-heading-two">Giảm còn</span> 
