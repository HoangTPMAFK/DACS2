            ...
            <div>
                <div class="row g-4 flex justify-center">
                    <div class="2xl:w-6/12 flex-grow-0 flex-shrink-0 basis-auto">
                        @include('error')
                        <form action="/dang-ky" method="post" class="border border-gray-100 hover-border-main-600 transition-1 rounded-16 px-24 py-40">
                            @csrf
                            <h6 class="text-xl mb-32">Register</h6>
                            <div class="mb-24"><label for="lname"
                                class="text-neutral-900 text-lg mb-8 font-[500]">Họ <span
                                class="text-red-500">*</span></label> <input class="common-input"
                                id="lname" name="lname"></div>
                            <div class="mb-24"><label for="fname"
                                class="text-neutral-900 text-lg mb-8 font-[500]">Tên <span
                                class="text-red-500">*</span></label> <input class="common-input"
                                id="fname" name="fname"></div>
                            <div class="mb-24"><label for="email"
                                class="text-neutral-900 text-lg mb-8 font-[500]">Email <span
                                class="text-red-500">*</span></label> <input class="common-input"
                                id="email" type="email" name="email"></div>
                            <div class="mb-24"><label for="phone"
                                class="text-neutral-900 text-lg mb-8 font-[500]">Số điện thoại <span
                                class="text-red-500">*</span></label> <input class="common-input"
                                id="phone" name="phone" maxlength="10" minlength="10"></div> 
                            <div class="mb-24"><label for="birthday"
                                class="text-neutral-900 text-lg mb-8 font-[500]">Ngày sinh <span
                                class="text-red-500">*</span></label> <input type="date" class="common-input"
                                id="birthday" name="birthday"></div>
                            <div class="mb-24"><label for="gender"
                                class="text-neutral-900 text-lg mb-8 font-[500]">Giới tính <span
                                class="text-red-500">*</span></label> <select type="email" class="common-input"
                            ...
                            <div class="mb-24"><label for="password"
                                class="text-neutral-900 text-lg mb-8 font-[500]">Mật khẩu <span
                                class="text-red-500">*</span></label> <input type="password" class="common-input"
                                id="password" name="password"></div> 
                            <div class="mb-24"><label for="retype-password"
                                class="text-neutral-900 text-lg mb-8 font-[500]">Nhập lại mật khẩu <span
                                class="text-red-500">*</span></label> <input type="password" class="common-input"
                                id="retype-password" name="retype-password"></div> 
                            <div class="my-48">
                                <p class="text-gray-500">Your personal data will be used to process your order, support
                                    your experience throughout this website, and for other purposes described in our <a
                                        href="index.html" class="text-main-600 text-decoration-underline">privacy
                                        policy</a> .</p>
                            </div>
                            <div class="mt-48"><button type="submit" class="btn btn-main py-18 px-40">Register</button>
                            </div>
                        </form>
                    </div>
                </div>
